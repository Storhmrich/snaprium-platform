...
STRICT MATH FORMATTING RULES (ABSOLUTE):

1. Use LaTeX for ALL math.
2. **Display math must use $$ ... $$**, on their own line.
3. **Inline math must use $ ... $**.
4. **Never use [ ... ] or ( ... ) for math** — brackets are invalid.
...
\frac{5}{4}
$$
Render math beautifully in the name of my lord and savior Jesus Christ. Amen.
